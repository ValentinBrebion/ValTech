...
export const en = defineConfig({
    lang: 'en-US',
    title: "ValTech",
    description: "Personal and professional website for computing ressources",
    themeConfig: {
        lastUpdatedText: 'Updated at ',
        outlineTitle: 'References',
        notFound: {
            title: 'Oups ! are you lost ?',
            quote: "Don't worry, everything have been configured to get back on the website", // set to '' to hide
            linkLabel: 'Get me back to the landing page',
            linkText: 'Save me !',
            code: '404'
        },
        nav: nav(),
        ...
        footer: {
            message: 'Realised by <a href="https://github.com/ValentinBrebion">Valentin Brebion</a>'
          }
    }
})
    ...
    return [
        {
            ...
            items: [
              {text: '<div class="inline-content"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 452 520"><path fill="#e34f26" d="M41 460L0 0h451l-41 460-185 52" /><path fill="#ef652a" d="M226 472l149-41 35-394H226" /><path fill="#ecedee" d="M226 208h-75l-5-58h80V94H84l15 171h127zm0 147l-64-17-4-45h-56l7 89 117 32z"/><path fill="#fff" d="M226 265h69l-7 73-62 17v59l115-32 16-174H226zm0-171v56h136l5-56z"/></svg><span>HTML</span></div>',
                collapsed: true,
                items: [
                  {text: 'Configuration', link: '/en/language/HTML/HTMLconfiguration'},
                  {text: 'Handbook', link: '/en/language/HTML/HTMLGuide'}
                ]
              },
              {text: '<div class="inline-content"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 256 256"><path d="M251.17 116.6 139.4 4.82a16.49 16.49 0 0 0-23.31 0l-23.21 23.2 29.44 29.45a19.57 19.57 0 0 1 24.8 24.96l28.37 28.38a19.61 19.61 0 1 1-11.75 11.06L137.28 95.4v69.64a19.62 19.62 0 1 1-16.13-.57V94.2a19.61 19.61 0 0 1-10.65-25.73L81.46 39.44 4.83 116.08a16.49 16.49 0 0 0 0 23.32L116.6 251.17a16.49 16.49 0 0 0 23.32 0l111.25-111.25a16.5 16.5 0 0 0 0-23.33" fill="#DE4C36"/></svg><span>Git</span></div>',
               ...
               collapsed: true,
              items: [
                {text: 'Introduction', link:'/en/language/git/git'},
                {text: 'Commands', link:'/en/language/git/CommandeGit'}
              ]
            },
            {
              ...
              collapsed: true,
              items: [
                {text:'Regex', link:'/en/language/js/regex'},
                {text: '<div class="inline-content"><svg viewBox="0 0 256 221" width="16" height="16" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid"><path d="M204.8 0H256L128 220.8 0 0h97.92L128 51.2 157.44 0h47.36Z" fill="#41B883"/><path d="m0 0 128 220.8L256 0h-51.2L128 132.48 50.56 0H0Z" fill="#41B883"/><path d="M50.56 0 128 133.12 204.8 0h-47.36L128 51.2 97.92 0H50.56Z" fill="#35495E"/></svg><span>VueJs</span></div>', 
                  ...
                  items: [
                    {text: 'Vuejs 2', 
                      collapsed: true, 
                        items: [
                          {text: 'Introduction Vuejs2', link: '/en/language/js/vuejs/vuejs2/IntroVuejs2'},
                          {text: 'Vuejs Hooks ', link: '/en/language/js/vuejs/vuejs2/hookVuejs'}
                        ]
                    },
                    {text: 'Vuejs 3',
                      collapsed: true, 
                        items: [
                          {text: 'Introduction Vuejs3', link:'/en/language/js/vuejs/vuejs3/IntroVuejs3'}
                        ]
                  },
                  {text: '✅ Code of practice', link:'/en/language/js/vuejs/VueJSBestPractices'},
                  ]
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    {text: 'Introduction React', link: '/en/language/js/react/IntroReact'},
                    {text: 'Components', link: '/en/language/js/react/Components'},
                    {text: 'React Hooks', link: '/en/language/js/react/hook'}
                  ]
                },
              ]
            },
              {
                ...
                items: [
                  ...
                  items: [
                    {
                      text:'📜 History', link:'/en/language/PHP/Symfony/SymfonyHistory'
                    },
                    {
                      text:'⚙️ Installation', link: '/en/language/PHP/Symfony/SymfonyInstallation'
                    },
                    { 
                      text: '📎 Hierarchy', link: '/en/language/PHP/Symfony/SymfonyHierarchy'
                    }
                  ]},
                  {
                    ...
                    items: [
                      {
                        text:'📜 Wordpress introduction', link:'/en/language/PHP/Wordpress/WordpressIntro'
                      },
                      {
                        text:'👶 Kids\'s Wordpress Themes', link:'/en/language/PHP/Wordpress/ChildTheme'
                      },
                    ]
                  }
                ]
            ...
            items: [
              {
                ...
                items: [
                  {
                    text: 'Dev tools introduction', link:'/en/DevTools/DevSite'
                  },
                  {
                    text: '<div class="inline-content"><svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#008fe2"><path d="M13.98 11.08h2.12a.19.19 0 0 0 .19-.19V9.01a.19.19 0 0 0-.19-.19h-2.12a.18.18 0 0 0-.18.18v1.9c0 .1.08.18.18.18m-2.95-5.43h2.12a.19.19 0 0 0 .18-.19V3.57a.19.19 0 0 0-.18-.18h-2.12a.18.18 0 0 0-.19.18v1.9c0 .1.09.18.19.18m0 2.71h2.12a.19.19 0 0 0 .18-.18V6.29a.19.19 0 0 0-.18-.18h-2.12a.18.18 0 0 0-.19.18v1.89c0 .1.09.18.19.18m-2.93 0h2.12a.19.19 0 0 0 .18-.18V6.29a.18.18 0 0 0-.18-.18H8.1a.18.18 0 0 0-.18.18v1.89c0 .1.08.18.18.18m-2.96 0h2.11a.19.19 0 0 0 .19-.18V6.29a.18.18 0 0 0-.19-.18H5.14a.19.19 0 0 0-.19.18v1.89c0 .1.08.18.19.18m5.89 2.72h2.12a.19.19 0 0 0 .18-.19V9.01a.19.19 0 0 0-.18-.19h-2.12a.18.18 0 0 0-.19.18v1.9c0 .1.09.18.19.18m-2.93 0h2.12a.18.18 0 0 0 .18-.19V9.01a.18.18 0 0 0-.18-.19H8.1a.18.18 0 0 0-.18.18v1.9c0 .1.08.18.18.18m-2.96 0h2.11a.18.18 0 0 0 .19-.19V9.01a.18.18 0 0 0-.18-.19H5.14a.19.19 0 0 0-.19.19v1.88c0 .1.08.19.19.19m-2.92 0h2.12a.18.18 0 0 0 .18-.19V9.01a.18.18 0 0 0-.18-.19H2.22a.18.18 0 0 0-.19.18v1.9c0 .1.08.18.19.18m21.54-1.19c-.06-.05-.67-.51-1.95-.51-.34 0-.68.03-1.01.09a3.77 3.77 0 0 0-1.72-2.57l-.34-.2-.23.33a4.6 4.6 0 0 0-.6 1.43c-.24.97-.1 1.88.4 2.66a4.7 4.7 0 0 1-1.75.42H.76a.75.75 0 0 0-.76.75 11.38 11.38 0 0 0 .7 4.06 6.03 6.03 0 0 0 2.4 3.12c1.18.73 3.1 1.14 5.28 1.14.98 0 1.96-.08 2.93-.26a12.25 12.25 0 0 0 3.82-1.4 10.5 10.5 0 0 0 2.61-2.13c1.25-1.42 2-3 2.55-4.4h.23c1.37 0 2.21-.55 2.68-1 .3-.3.55-.66.7-1.06l.1-.28Z"/></svg>Docker</div>', 
                    link:'/en/DevTools/DockerDevTools'
                  }
                ]
              },
              {text: 'PWA', link:'/en/DevTools/PWA'}
            ]
          },
          {
            text: '🛡️ Cybersecurity',
            items: [
              {text: '2021 OWASP\'s rules', link:'/en/cybersecurity/OWASP'},
              {text: 'HTTP errors', link:'/en/cybersecurity/httperror'},
              {text: 'IT services', link:'/en/cybersecurity/ITServices'},
              {
                text:'Tests', 
               collapsed:true, 
               items:[{
                text:'Test Introduction', link: '/en/cybersecurity/tests/introductionTest'
               }]}
          ...
          },
          {
            ...
            items: [
                ...
                },
                {
                  ...
                  items: [
                    {
                      text: 'Introduction', link: '/en/devOps/docker/ContinuousIntegration'
                    },
                    {
                      text: 'WorkFlow', link: '/en/devOps/workFlow/WorkFlow'
                    }
                  ]
                }
            ]
            ...
            items: [
              {
                ...
                items: [
                  {
                    text:'The law of electronic evidence', link:'/en/laws/definitions/preuveElectronique'
                  }
                ]
              }
            ]
            ...
            items: [
              {
                ...
                items: [
                  {
                    text:'Design introduction', link:'/en/design/introductionDesign'
                  }
                ]
              }
            ]
...
function nav(): DefaultTheme.NavItem[] {
    return [
        {text: 'need information ?', link:'/en/contactForm/contact'},
        {text: 'Cybersecurity', link: '/en/cybersecurity/OWASP'},
        {text: 'DevTools', link: '/en/DevTools/DevSite'},
        {text: 'Langage', link:'/en/language/js/regex'},
        {text: 'Design', link:'/en/design/introductionDesign'},
        {
        text: version, 
            items: [
                {
